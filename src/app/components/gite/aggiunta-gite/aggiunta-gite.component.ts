...
@Component({
  ...
  templateUrl: './aggiunta-gite.component.html',
  styleUrl: './aggiunta-gite.component.css',
})
export class AggiuntaGiteComponent implements OnDestroy,OnInit{
...
be considered as 2024 - 03 - 02`
  ...
  ngOnInit(): void {
    this.u.aggiuntaAttiva.trips = true
  ...
  ngOnDestroy(): void {
    this.u.aggiuntaAttiva.trips = false
  }
  ...
  aggiuntaElemento(f:NgForm){
    ...
    if(this.u.datiUtente.trips == undefined){
      this.u.datiUtente['trips'] = [
        {
          id:0,
      ...
      this.u.datiUtente.trips.push({
        id:this.u.datiUtente.trips.length,
        title:f.value.titolo,
        start_date:inizio.getFullYear() + ' - ' + meseI + ' - ' + giornoI + ' ' + f.value.oraInizio,
        end_date:fine.getFullYear() + ' - ' + meseF + ' - ' + giornoF + ' ' + f.value.oraFine,
        start_day:inizio.getFullYear() + ' - ' + meseI + ' - ' + giornoI,
